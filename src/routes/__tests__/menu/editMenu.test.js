...
import { menu as mockData } from 'src/utils/test-utils/mockData';
...
describe('Menu Routes: Edit menu', () => {
  it('should edit a menu for authenticated user', (done) => {
    request(app)
      .put('/menu/6f27c0fb-19a9-4d9e-b5a1-d97c2d426ab5')
  ...
  it('should not edit expired menu for authenticated user', (done) => {
    request(app)
      .put('/menu/15421f7a-0f82-4802-b215-e0e8efb6bfb3')
      .set('Accept', 'application/json')
      .set('authorization', foodCircleToken)
      .send(menuDetailsWithoutDate)
      .end((err, res) => {
        expect(res.statusCode).toBe(400);
        expect(res.body.error).toBe('Menu Expired');
  ...
  it('should return errors for invalid input', (done) => {
    request(app)
      .put('/menu/a9fa6cb3-9f5e-46fa-b641-388f898ca824')
      .set('Accept', 'application/json')
      .set('authorization', foodCircleToken)
  ...
  invalidID({
    type: 'menuId',
    method: 'put',
    url: '/menu/efbbf4ad-c4ae-4134-928d-b5ee305ed5396478',
    token: foodCircleToken,
  });

  notFound({
    method: 'put',
    url: '/menu/4f579f84-53e4-4fc5-a362-956aa36fbfb8',
    token: foodCircleToken,
    data: menuDetailsWithoutDate,
  });

  notAdmin('put', '/menu/15421f7a-0f82-4802-b215-e0e8efb6bfb3');

  unAuthorized('put', '/menu/15421f7a-0f82-4802-b215-e0e8efb6bfb3');
});
